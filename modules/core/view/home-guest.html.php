					...
					<div class="search" style="border-radius: 10px">
						<div class="input-field col s12">
							<div class="input-field col s4">
								<select name="selectedCategory" style="height: 30px;color: #444; font-size: 14px; padding: 0 20% 0 5%; line-height: 28px; font-family: 'Montserrat', sans-serif !important" id="categorySelect">
									<option value="" selected="">Todas las Categorías</option>
									<option value="escort-para-hombre" data-name="Escort para hombre">Escort para hombre</option>
								</select>
							</div>
							<div class="input-field col s4">
								<select id="provinceSelect" tabindex="-1" aria-hidden="true">
									<option id="provinceDefaultValue" value="">Todas las provincias</option>
								</select>
							</div>
							<div class="input-field col s4">
								<label for="searchCity"></label>
								<input id="searchCity" name="searchCity" type="search" class="" placeholder="Ciudad / Zona / Pueblos" value="">
							</div>
							<div class="input-field col s11">
								<input id="searchText" name="searchText" type="search" class="form-control h-75  col fs-14 me-1" placeholder="Buscar:" value="">
							</div>
