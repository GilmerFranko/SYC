...
if (isset($_GET['new_thread']))
{
  ...
  {
    $msg[] = ['Debes introducir un t&iacute;tulo', 'error'];
  }

  // Verifica si no se ha introducido un correo electrónico
  if (!isset($_POST['email']) || empty($_POST['email']))
  {
    $msg[] = ['Debes introducir un correo electrónico', 'error'];
  }
  ...
  {
    $msg[] = ['El telefono debe tener al menos 9 digitos y ser un numero', 'error'];
  }
  ...
  {
    $msg[] = ['Debes seleccionar una ubicación', 'error'];
  }
